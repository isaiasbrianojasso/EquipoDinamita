...
public class Game extends World
{
    ...
    {
        super(1024, 480, 1);
        setActOrder(Floor.class,Wall.class,Forniture.class,Character.class,LittleSpider.class,BossSpider.class,Inventory.class,Pause.class,SelectLight.class,KeyObject.class,TextBox.class,HUD.class);
        prepare();
        act();
    }
